(function() {
  ...
  function displayOption(options, doubleDeposit, multipleBanks) {
    ...
    if (options.length > 0) {
      $(
        '<h5 style="text-align: center;">Below are offers for $' +
          localStorage.getItem("amount") +
          ". You must click the ORDER button before you receive instructions to pay at the Cash Payment center. </h5>"
      ).insertAfter("#header");
    }
      ...
      for (var i = 0; i < options.length; i++) {
        ...
        if (options[i].crypto == currency[j].code) {
          if (options[i].crypto == "DASH") {
            if (address != "") {
              $("#offer_div").append(
                '<div class="row list-group"><div class="col-sm-12"><div class="list bgc-fff pad-10 box-shad  property-listing"><div class="media"><a class="pull-left" href="#" target="_parent"><img alt="image" style="height: 50px; width: 50px;"class="img-responsive" src=' +
                  options[i].bankLogo +
                  '></a><div class="media-body fnt-smaller"><a href="#" target="_parent"  style="color: #080808;"></a><p class="media-heading" style="text-align: left;"><a href="#" target="_parent" style="color: #080808;"><span>' +
                  currency[j].symbol +
                  " " +
                  options[i].amount.DASH +
                  '</span><small class="pull-right"><button type="button" class="btn btn-success" id="orderBtn" name="orderBtn" onclick="holdCreate(' +
                  i +
                  "," +
                  options.length +
                  ');">ORDER</button><input type="hidden" id="offerId_' +
                  i +
                  '" name="offerId_' +
                  i +
                  '" value="' +
                  options[i].id +
                  '"></small></a></p><p style="margin: 0px; text-align: left;">(' +
                  currency[j].minorSymbol +
                  " " +
                  options[i].amount.dots +
                  ')</p><p class="media-heading" style="margin: 0px; text-align: left;"><a href="#" target="_parent" style="color: #080808;"><span>' +
                  options[i].bankName +
                  '</span></a></p><small class="pull-right">Pay $' +
                  options[i].deposit.amount +
                  '</small><p style="margin: 0px; text-align: left;">' +
                  options[i].address +
              ...
              $("#offer_div").append(
                '<div class="row list-group"><div class="col-sm-12"><div class="list bgc-fff pad-10 box-shad  property-listing"><div class="media"><a class="pull-left" href="#" target="_parent"><img alt="image" style="height: 50px; width: 50px;"class="img-responsive" src=' +
                  ...
                  ')</p><p class="media-heading" style="margin: 0px; text-align: left;"><a href="#" target="_parent" style="color: #080808;"><span>' +
                  options[i].bankName +
                  '</span><small class="pull-right" style="margin-right: -60px; margin-top: 5px;">Pay $' +
                  options[i].deposit.amount +
                  '</small></a></p><p style="margin: 0px; text-align: left;">Subject to local availability  ' +
                  '<a class="pull-right" href="' +
                  options[i].bankLocationUrl +
                  '">Check Location' +
    ...
    if (doubleDeposit.length > 0) {
      $(
        '<h5 style="text-align: center;">Best Value Options: More ' +
          localStorage.getItem("Crypto") +
          " for $" +
          localStorage.getItem("amount") +
          " Cash</h5>"
      ).insertAfter("#offer_div");
    }
      ...
      for (var i = 0; i < doubleDeposit.length; i++) {
        ...
        if (firstOffer.crypto == currency[j].code) {
          if (firstOffer.crypto == "DASH") {
            if (address != "") {
              $("#doubleDeposit_div").append(
                '<div class="row list-group"><div class="col-sm-12"><div class="list bgc-fff pad-10 box-shad  property-listing"><div class="media"><a class="pull-left" href="#" target="_parent"><img alt="image" style="height: 50px; width: 50px;"class="img-responsive" src=' +
                  firstOffer.bankLogo +
                  '></a><div class="media-body fnt-smaller"><a href="#" target="_parent"  style="color: #080808;"></a><p class="media-heading" style="text-align: left;"><a href="#" target="_parent" style="color: #080808;"><span>' +
                  currency[j].symbol +
                  " " +
                  firstOffer.amount.DASH +
                  '</span><small class="pull-right"><button type="button" class="btn btn-success" id="orderBtn" name="orderBtn" onclick="holdCreate(' +
                  i +
                  "," +
                  doubleDeposit.length +
                  ');">ORDER</button><input type="hidden" id="offerId_' +
                  i +
                  '" name="offerId_' +
                  i +
                  ...
                  currency[j].minorSymbol +
                  " " +
                  firstOffer.amount.dots +
                  ')</p><p class="media-heading" style="margin: 0px; text-align: left;"><a href="#" target="_parent" style="color: #080808;"><span>' +
                  firstOffer.bankName +
                  '</span></a></p><small class="pull-right">Pay $' +
                  firstOffer.deposit.amount +
                  '</small><p style="margin: 0px; text-align: left;">' +
                  firstOffer.address +
                  "</p></div></div></div></div></div>"
              );
        ...
        if (secondOffer.crypto == currency[j].code) {
          if (secondOffer.crypto == "DASH") {
            if (address != "") {
              $("#doubleDeposit_div").append(
                '<div class="row list-group"><div class="col-sm-12"><div class="list bgc-fff pad-10 box-shad  property-listing"><div class="media"><a class="pull-left" href="#" target="_parent"><img alt="image" style="height: 50px; width: 50px;"class="img-responsive" src=' +
                  secondOffer.bankLogo +
                  '></a><div class="media-body fnt-smaller"><a href="#" target="_parent"  style="color: #080808;"></a><p class="media-heading" style="text-align: left;"><a href="#" target="_parent" style="color: #080808;"><span>' +
                  currency[j].symbol +
                  " " +
                  secondOffer.amount.DASH +
                  '</span><small class="pull-right"><button type="button" class="btn btn-success" id="orderBtn" name="orderBtn" onclick="holdCreate(' +
                  i +
                  "," +
                  doubleDeposit.length +
                  ...
                  currency[j].minorSymbol +
                  " " +
                  secondOffer.amount.dots +
                  ')</p><p class="media-heading" style="margin: 0px; text-align: left;"><a href="#" target="_parent" style="color: #080808;"><span>' +
                  secondOffer.bankName +
                  '</span></a></p><small class="pull-right">Pay $' +
                  secondOffer.deposit.amount +
                  '</small><p style="margin: 0px; text-align: left;">' +
                  secondOffer.address +
                  "</p></div></div></div></div></div>"
              );
      ...
      for (var i = 0; i < multipleBanks.length; i++) {
        ...
        if (multipleOffer.crypto == currency[j].code) {
          if (multipleOffer.crypto == "DASH") {
            if (address != "") {
              $("#multiplebanks_div").append(
                '<div class="row list-group"><div class="col-sm-12"><div class="list bgc-fff pad-10 box-shad  property-listing"><div class="media"><a class="pull-left" href="#" target="_parent"><img alt="image" style="height: 50px; width: 50px;"class="img-responsive" src=' +
                  multipleOffer.bankLogo +
                  '></a><div class="media-body fnt-smaller"><a href="#" target="_parent"  style="color: #080808;"></a><p class="media-heading" style="text-align: left;"><a href="#" target="_parent" style="color: #080808;"><span>' +
                  currency[j].symbol +
                  " " +
                  multipleOffer.amount.DASH +
                  '</span><small class="pull-right"><button type="button" class="btn btn-success" id="orderBtn" name="orderBtn" onclick="holdCreate(' +
                  i +
                  "," +
                  multipleBanks.length +
                  ');">ORDER</button><input type="hidden" id="offerId_' +
                  i +
                  '" name="offerId_' +
                  i +
                  ...
                  currency[j].minorSymbol +
                  " " +
                  multipleOffer.amount.dots +
                  ')</p><p class="media-heading" style="margin: 0px; text-align: left;"><a href="#" target="_parent" style="color: #080808;"><span>' +
                  multipleOffer.bankName +
                  '</span></a></p><small class="pull-right">Pay $' +
                  multipleOffer.deposit.amount +
                  '</small><p style="margin: 0px; text-align: left;">' +
  ...
  var actions = {
    ...
    discovery: function() {
      ...
      if (latitude != null && longitude != null) {
        var postData = {
          browserLocation: ["latitude", latitude, "longitude", longitude],
          country: "us",
    ...
    getOffers: function() {
      $.ajax({
        url:
          apiUrl +
          "/api/v1/discoveryInputs/" +
          localStorage.getItem("discoveryId") +
          "/offers/",
        headers: { "X-Coins-Publisher": publisherId },
        success: function(data) {
          //localStorage.removeItem("discoveryId");
